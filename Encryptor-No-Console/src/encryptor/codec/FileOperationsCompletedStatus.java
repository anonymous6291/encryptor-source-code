...
public class FileOperationsCompletedStatus {
    ...
    private volatile double MAX_LENGTH;
    ...
    public FileOperationsCompletedStatus(double MAX_LENGTH) {
    ...
    public double getProgress() {
        ...
        return Math.min((completed * 100.0) / MAX_LENGTH, 100.0);
    }
